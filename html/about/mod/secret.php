...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=1024" /><title>about/mod/secret.php</title></head>
...
<h2>about/mod/secret.php</h2>
<p>Congratulations, you have found the secret page. From here you may add content to <a href="http://www.public404.com/about/mod">about/mod: </a><!--SERVER SENSITIVE-->
  <!-- HTML FORM -->
</p>
...
//fill table with row of data when user presses submit
 ...
 //because I hate arrays...
	...
	$stmt->execute();
       if ($page == '') {
		   echo "Your post was submitted to <a href='http://www.public404.com/about/mod'>about/mod</a>"; // !!!!! SERVER SENSITIVE !!!!!
	   } else {
     echo "Your post was submitted to <a href='" . $page . "'>about/mod/" . $page . "</a> ";
	 }
} catch(PDOException $e) {
  echo 'Error: ' . $e->getMessage();
}//end catch
